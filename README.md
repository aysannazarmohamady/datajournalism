...
با این حال، تنها تعداد کمی از روزنامه‌نگاران تا اواسط دهه 1980 از این تکنیک‌ها استفاده کردند، زمانی که الیوت جاسپین در ایالات متحده به دلیل تجزیه و تحلیل پایگاه‌های اطلاعاتی داستان‌ها، از جمله داستان‌های مربوط به رانندگان اتوبوس‌های مدرسه خطرناک و یک رسوایی سیاسی مربوط به وام‌های خانه، در The Providence Journal Bulletin به رسمیت شناخته شد.

جاسپین که جایزه پولیتزر را برای گزارش سنتی درباره فساد اتحادیه‌های کارگری دریافت کرده بود، در دانشگاه کلمبیا نیز برای یادگیری نحوه استفاده از داده‌ها بورسیه تحصیلی کرده بود. این همان دانشگاهی بود که استیو راس، روزنامه‌نگار و استادی در آن سال‌ها تکنیک‌های تجزیه و تحلیل داده‌ها را آموزش می‌داد. در اواخر دهه 1980، حدود 50 روزنامه‌نگار دیگر در سراسر ایالات متحده، که اغلب با مایر، جاسپین، یا استیو دوگ از میامی هرالد مشورت می‌کردند، شروع به استفاده از تجزیه و تحلیل داده‌ها برای داستان‌های خود کردند.
